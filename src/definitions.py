...
external_urls = {
    ...
    'blog post': 'https://www.freecodecamp.org/news/how-to-use-github-as-a-pypi-server-1c3b0d07db2/'
}
...
server = {
    ...
    'description': (
        f'This website serves as a PyPi-like package server for the MetPy packages. '
        f'It conforms to Pep 503. It is based on a blog post by freeCodeCamp.'),
    'image': 'folder.png',
...
magnitude = {
    ...
    'license': 'GNU GPL 3.0',
    'description': (
        f'allows to perform simple operations with magnitudes including units and uncertainties. '
